...
```{r PlotBinComparison, echo=FALSE, out.width="100%", fig.cap="Figure 1. White light exposure, log scaled.", fig.height=3, fig.width=12, warning=FALSE}
p_all_bins
```
...
```{r PlotTimeSeries, include=FALSE}
...
```{r WeekdayColor, echo=FALSE, fig.cap="Figure 2", fig.height=10, fig.width=12, warning=FALSE, out.width="100%"}
gridExtra::grid.arrange(cp_color, pp_color, ncol = 2)
```

```{r WeekdayWhite, echo=FALSE, fig.cap="Figure 3", fig.height=10, fig.width=12, warning=FALSE, out.width="100%"}
gridExtra::grid.arrange(cp_white, pp_white, ncol = 2)
```

```{r WeekdayActitity, echo=FALSE, fig.cap="Figure 4", fig.height=10, fig.width=12, warning=FALSE, out.width="100%"}
gridExtra::grid.arrange(cp_activity, pp_activity, ncol = 2)
```

```{r WeekdaySleep, echo=FALSE, fig.cap="Figure 5", fig.height=10, fig.width=12, warning=FALSE, out.width="100%"}
...
```{r echo=FALSE, fig.width=13, fig.height=3, warning=FALSE}
...
```{r echo=FALSE, warning=FALSE, fig.width=15, fig.height=3}
...
Sleep status over time depends on...

- insomnia diagnosis.
- current red light exposure / differential reaction to red light exposure
- current partner-activity.
- lagged partner-activity.
...
# test
# dyad |>
#   dplyr::filter(.data$time == hms::as_hms("17:05:00")) |>
...
```{r eval=FALSE, include=FALSE}
model <- "sleep_wake ~ time + partner_activity + red_light"
